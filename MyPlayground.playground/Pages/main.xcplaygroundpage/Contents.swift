...
*/
// write your code here
func isGreater(lhs lsh: Int, rhs: Int) -> Bool {
	if lsh > rhs {
		return true
	}
	return false
...
*/
// write your code here
func isForceWith(name name: String) -> Bool {
	let strongForce = ["Luke", "Leia", "Anakin", "Obi Wan", "Yoda", "Vader"]
	
	if strongForce.contains(name) {
		return true
	}
	return false
}
...
func transferFunds(from from: Double, to: Double) {
